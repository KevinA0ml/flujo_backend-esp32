...
const char* ssid = "kaml"; //estoy en la red del trabajo cambiar.
const char* password = "kaml1223"; //estoy en la red del trabajo cambiar.
const char* serverUrl = "http://192.168.157.211:3001/datos"; // Cambia 'tu_servidor' por la dirección IP o dominio de tu servidor
...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    if (receivedChar == 'v' || receivedChar == 'V') {
      ...
      doc["nombrecompleto"] = "Kevin Mo";
      doc["correouniversidad"] = "kmol@miumg.edu.gt";
      doc["carne"] = "0902-21-3930";
